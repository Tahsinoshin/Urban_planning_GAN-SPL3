...
def get_params():
    ...
    parser.add_argument("--cond_dim", type=int, default=5, help="the dimension of conditional vector.")
    parser.add_argument("--input_dim", type=int, default=200005, help="the dimension of conditional vector.")
...
def compute_loss(model, x, func_zone, cond_dim):
  ...
  return -tf.reduce_mean(logpx_z + logpz - logqz_x) + 0.1 * func_loss
...
result = []
for test_x in test_dataset:
    generate_solution = generate_solutions(model,test_x[2][:,-5:])
