...
cluvae_5 = np.load("./tmp/5_cgan_generate_result.npz")["arr_0"]
print_all_metrics("cgan_5",con_label,green_s,cluvae_5)

with open("../../data/green_standards_10.pkl","rb") as f:
    green_s = pickle.load(f)
cluvae_10 = np.load("./tmp/10_cgan_generate_result.npz")["arr_0"]
print_all_metrics("cgan_10",con_label,green_s,cluvae_10)

with open("../../data/green_standards_25.pkl","rb") as f:
    green_s = pickle.load(f)
cluvae_25 = np.load("./tmp/25_cgan_generate_result.npz")["arr_0"]
print_all_metrics("cgan_25",con_label,green_s,cluvae_25)

with open("../../data/green_standards_50.pkl","rb") as f:
    green_s = pickle.load(f)
cluvae_50 = np.load("./tmp/50_cgan_generate_result.npz")["arr_0"]
print_all_metrics("cgan_50",con_label,green_s,cluvae_50)
