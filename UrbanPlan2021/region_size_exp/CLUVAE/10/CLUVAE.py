...
def get_params():
    ...
    parser.add_argument("--input_dim", type=int, default=2015, help="the dimension of conditional vector.")
...
result = generate_us.reshape((generate_us.shape[0],10,10,20))
np.savez_compressed("../tmp/10_cluvae_generate_result.npz",result)
