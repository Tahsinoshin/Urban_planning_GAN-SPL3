...
def get_params():
    ...
    parser.add_argument("--input_dim", type=int, default=515, help="the dimension of conditional vector.")
...
result = generate_us.reshape((generate_us.shape[0],5,5,20))
np.savez_compressed("../tmp/5_cluvae_generate_result.npz",result)
