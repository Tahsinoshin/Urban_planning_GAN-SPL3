...
cluvae_5 = np.load("./tmp/5_dcgan_generate_result.npz")["arr_0"]
print_all_metrics("dcgan_5",con_label,green_s,cluvae_5)

with open("../../data/green_standards_10.pkl","rb") as f:
    green_s = pickle.load(f)
cluvae_10 = np.load("./tmp/10_dcgan_generate_result.npz")["arr_0"]
print_all_metrics("dcgan_10",con_label,green_s,cluvae_10)

with open("../../data/green_standards_25.pkl","rb") as f:
    green_s = pickle.load(f)
cluvae_25 = np.load("./tmp/25_dcgan_generate_result.npz")["arr_0"]
print_all_metrics("dcgan_25",con_label,green_s,cluvae_25)

with open("../../data/green_standards_50.pkl","rb") as f:
    green_s = pickle.load(f)
cluvae_50 = np.load("./tmp/50_dcgan_generate_result.npz")["arr_0"]
print_all_metrics("dcgan_50",con_label,green_s,cluvae_50)
